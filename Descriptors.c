...
const USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor = {
        .Config =
        {
                ...
                .MaxPowerConsumption = USB_CONFIG_POWER_MA(75)
        },
        ...
        .HID_ReportINEndpoint =
        {
                ...
                .EndpointAddress = GAMEPAD_EPADDR,
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"Sleepy");

/** Product descriptor string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"SBus Gamepad");
