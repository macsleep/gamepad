...
/** \file
 *
 * functions for reading the sbus rx_buffers via an inverter into the UART of the teensy
 */
...
ISR(TIMER1_OVF_vect) {
    ...
    uart_debug(rx_buffer_head, rx_buffer[3], rx_buffer[4], rx_buffer[SBUS_FLAGS]);
